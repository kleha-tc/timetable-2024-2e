...
const TimeTable = () => {
    ...
    const [period, setPeriod] = useState("early_period_3")
    return (
        <>
            <NativeSelect defaultValue={"early_period_3"} onChange={(event) => setPeriod(event.target.value)}>
                <option value="early_period">前期</option>
                <option value="late_period">後期</option>
								<option value="early_period_3">3年前期</option>
            </NativeSelect>
